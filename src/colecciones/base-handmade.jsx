    ...
    <>
      ...
      <main>
        <div className="breadcrumb-boutique">
          ...
          <span className="breadcrumb-current">BASE HANDMADE</span>
        </div>
        ...
        <div className="boutique-info">
          <p>5''x5'' & 4''x8'' · ALTERET</p>
          <p>H2</p>
        </div>

        <ColeccionLayout infoUrl="https://www.alteret.com/en/products/7262-handmade-wall-tiles/14742-inspiration-patterns/p-139973-base-8-straight-set" />
