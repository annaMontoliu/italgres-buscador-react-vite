...
const images = [norvins01];

export function Norvins() {
    ...
    <>
      ...
      <main>
        <div className="breadcrumb-boutique">
          ...
          <span className="breadcrumb-current">NORVINS</span>
        </div>

        <h1 className="titulo-coleccion boutique-title">NORVINS</h1>
        ...
        <ColeccionLayout infoUrl="/pdf/NORVINS.pdf" />
