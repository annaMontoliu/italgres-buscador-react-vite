...
const images = [manila01];

export function Manila() {
    ...
    <>
      ...
      <main>
        <div className="breadcrumb-boutique">
          ...
          <span className="breadcrumb-current">MANILA</span>
        </div>

        <h1 className="titulo-coleccion boutique-title">MANILA</h1>
