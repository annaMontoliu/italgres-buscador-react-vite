...
const images = [florentina01];

export function Florentina() {
    ...
    <>
      ...
      <main>
        <div className="breadcrumb-boutique">
          ...
          <span className="breadcrumb-current">FLORENTINA</span>
        </div>

        <h1 className="titulo-coleccion boutique-title">FLORENTINA</h1>
        ...
        <ColeccionLayout infoUrl="/pdf/FLORENTINA.pdf" />
