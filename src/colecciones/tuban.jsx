    ...
    <>
      ...
      <main>
        <div className="breadcrumb-boutique">
          ...
          <span className="breadcrumb-current">TUBAN</span>
        </div>

        <h1 className="titulo-coleccion boutique-title">TUBAN</h1>
        ...
        <ColeccionLayout infoUrl="/pdf/TUBAN.pdf" />
