...
import saville1 from "../assets/imagenes/saville/saville-01.jpg";

const images = [
  saville1,
];

export function Saville() {
    ...
    <>
      ...
      <main>
        <div className="breadcrumb-boutique">
          ...
          <span className="breadcrumb-current">SAVILLE</span>
        </div>

        <h1 className="titulo-coleccion boutique-title">SAVILLE</h1>
        ...
        <ColeccionLayout infoUrl="/pdf/SAVILLE.pdf" />
