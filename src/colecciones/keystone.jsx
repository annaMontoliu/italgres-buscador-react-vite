...
import img01 from "../assets/imagenes/keystone/keystone-01.jpg";
import img02 from "../assets/imagenes/keystone/keystone-02.jpg";
import img03 from "../assets/imagenes/keystone/keystone-03.jpg";
import img04 from "../assets/imagenes/keystone/keystone-04.jpg";
    ...
    <>
      ...
      <main>
        <div className="breadcrumb-boutique">
          ...
          <span className="breadcrumb-current">KEYSTONE</span>
        </div>

        <h1 className="titulo-coleccion boutique-title">KEYSTONE</h1>
