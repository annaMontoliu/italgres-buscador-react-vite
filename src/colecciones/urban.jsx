...
import urban02 from "../assets/imagenes/urban/urban-02.jpg";

const images = [urban01, urban02];
    ...
    <>
      ...
      <main>
        <div className="breadcrumb-boutique">
          ...
          <span className="breadcrumb-current">URBAN</span>
        </div>

        <h1 className="titulo-coleccion boutique-title">URBAN</h1>
        ...
        <ColeccionLayout infoUrl="https://cifreceramica.com/en/pdf-coleccion/URBAN/" />
