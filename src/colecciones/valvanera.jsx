    ...
    <>
      ...
      <main>
        <div className="breadcrumb-boutique">
          ...
          <span className="breadcrumb-current">VALVANERA</span>
        </div>

        <h1 className="titulo-coleccion boutique-title">VALVANERA</h1>
        ...
        <ColeccionLayout infoUrl="/pdf/VALVANERA.pdf" />
