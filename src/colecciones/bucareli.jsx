...
import bucareli02 from "../assets/imagenes/bucareli/bucareli-02.jpg";

const images = [bucareli01, bucareli02];

export function Bucareli() {
    ...
    <>
      ...
      <main>
        <div className="breadcrumb-boutique">
          ...
          <span className="breadcrumb-current">BUCARELI</span>
        </div>

        <h1 className="titulo-coleccion boutique-title">BUCARELI</h1>
        ...
        <ColeccionLayout infoUrl="/pdf/BUCARELI.pdf" />
