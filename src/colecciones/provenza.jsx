...
import provenza02 from "../assets/imagenes/provenza/provenza-02.jpg";
    ...
    <>
      ...
      <main>
        <div className="breadcrumb-boutique">
          ...
          <span className="breadcrumb-current">PROVENZA</span>
        </div>

        <h1 className="titulo-coleccion boutique-title">PROVENZA</h1>
