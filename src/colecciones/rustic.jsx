...
import rustic02 from "../assets/imagenes/rustic/rustic-02.jpg";
import rustic03 from "../assets/imagenes/rustic/rustic-03.jpg";
import rustic04 from "../assets/imagenes/rustic/rustic-04.jpg";

const images = [rustic01, rustic02, rustic03, rustic04];

export function Rustic({ onGoHome }) {
    ...
    <>
      ...
      <main>
        <div className="breadcrumb-boutique">
          ...
          <span className="breadcrumb-current">RUSTIC</span>
        </div>

        <h1 className="titulo-coleccion boutique-title">RUSTIC</h1>
