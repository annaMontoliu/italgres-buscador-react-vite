...
import fluxus1 from "../assets/imagenes/fluxus/fluxus-01.jpg";

const images = [
  fluxus1,
];

export function Fluxus() {
    ...
    <>
      ...
      <main>
        <div className="breadcrumb-boutique">
          ...
          <span className="breadcrumb-current">FLUXUS</span>
        </div>

        <h1 className="titulo-coleccion boutique-title">FLUXUS</h1>
        ...
        <ColeccionLayout infoUrl="/pdf/FLUXUS.pdf" />
