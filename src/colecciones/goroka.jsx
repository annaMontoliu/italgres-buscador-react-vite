...
import goroka02 from "../assets/imagenes/goroka/goroka-02.jpg";

const images = [goroka01, goroka02];

export function Goroka() {
    ...
    <>
      ...
      <main>
        <div className="breadcrumb-boutique">
          ...
          <span className="breadcrumb-current">GOROKA</span>
        </div>

        <h1 className="titulo-coleccion boutique-title">GOROKA</h1>
        ...
        <ColeccionLayout infoUrl="/pdf/GOROKA.pdf" />
