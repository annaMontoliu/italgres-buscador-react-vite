...
import jimbaran02 from "../assets/imagenes/jimbaran/jimbaran-02.jpg";

const images = [jimbaran01, jimbaran02];

export function Jimbaran() {
    ...
    <>
      ...
      <main>
        <div className="breadcrumb-boutique">
          ...
          <span className="breadcrumb-current">JIMBARAN</span>
        </div>

        <h1 className="titulo-coleccion boutique-title">JIMBARAN</h1>
        ...
        <ColeccionLayout infoUrl="/pdf/JIMBARAN.pdf" />
