...
const images = [halvmane01];

export function Halvmane() {
    ...
    <>
      ...
      <main>
        <div className="breadcrumb-boutique">
          ...
          <span className="breadcrumb-current">HALVMANE</span>
        </div>

        <h1 className="titulo-coleccion boutique-title">HALVMANE</h1>
        ...
        <ColeccionLayout infoUrl="/pdf/HALVMANE.pdf" />
