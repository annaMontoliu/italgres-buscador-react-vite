...
import eliseos02 from "../assets/imagenes/eliseos/eliseos-02.jpg";
import eliseos03 from "../assets/imagenes/eliseos/eliseos-03.jpg";

const images = [eliseos01, eliseos02, eliseos03];

export function Eliseos() {
    ...
    <>
      ...
      <main>
        <div className="breadcrumb-boutique">
          ...
          <span className="breadcrumb-current">ELISEOS</span>
        </div>

        <h1 className="titulo-coleccion boutique-title">ELISEOS</h1>
        ...
        <ColeccionLayout infoUrl="/pdf/ELISEOS.pdf" />
