    ...
    <>
      ...
      <main>
        <div className="breadcrumb-boutique">
          ...
          <span className="breadcrumb-current">TERA</span>
        </div>

        <h1 className="titulo-coleccion boutique-title">TERA</h1>
        ...
        <ColeccionLayout infoUrl="/pdf/TERA.pdf" />
