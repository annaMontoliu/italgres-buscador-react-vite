...
const images = [llagostera01];

export function Llagostera() {
    ...
    <>
      ...
      <main>
        <div className="breadcrumb-boutique">
          ...
          <span className="breadcrumb-current">LLAGOSTERA</span>
        </div>

        <h1 className="titulo-coleccion boutique-title">LLAGOSTERA</h1>
        ...
        <ColeccionLayout infoUrl="/pdf/LLAGOSTERA.pdf" />
