...
import zepto1 from "../assets/imagenes/zepto/zepto-01.jpg";

const images = [
  zepto1,
];

export function Zepto() {
    ...
    <>
      ...
      <main>
        <div className="breadcrumb-boutique">
          ...
          <span className="breadcrumb-current">ZEPTO</span>
        </div>

        <h1 className="titulo-coleccion boutique-title">ZEPTO</h1>
        ...
        <ColeccionLayout infoUrl="/pdf/ZEPTO.pdf" />
