...
import carnegie1 from "../assets/imagenes/carnegie/carnegie-01.jpg";

const images = [
  carnegie1,
];

export function Carnegie() {
    ...
    <>
      ...
      <main>
        <div className="breadcrumb-boutique">
          ...
          <span className="breadcrumb-current">CARNEGIE</span>
        </div>

        <h1 className="titulo-coleccion boutique-title">CARNEGIE</h1>
        ...
        <ColeccionLayout infoUrl="/pdf/CARNEGIE.pdf" />
