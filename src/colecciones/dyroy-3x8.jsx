...
import dyroy05 from "../assets/imagenes/dyroy/dyroy-3x8/dyroy-3x8-05.jpg";

const images = [dyroy01, dyroy02, dyroy03, dyroy04, dyroy05];
    ...
    <>
      ...
      <main>
        <div className="breadcrumb-boutique">
          ...
          <span className="breadcrumb-current">DYROY 3X8</span>
        </div>

        <h1 className="titulo-coleccion boutique-title">DYROY 3X8</h1>
