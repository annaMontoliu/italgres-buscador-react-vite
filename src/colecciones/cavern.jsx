...
import cavern1 from "../assets/imagenes/cavern/cavern-01.jpg";
import cavern2 from "../assets/imagenes/cavern/cavern-02.jpg";
    ...
    <>
      ...
      <main>
        <div className="breadcrumb-boutique">
          ...
          <span className="breadcrumb-current">CAVERN</span>
        </div>

        <h1 className="titulo-coleccion boutique-title">CAVERN</h1>
        ...
        <ColeccionLayout infoUrl="/pdf/CAVERN.pdf" />
