...
import linden02 from "../assets/imagenes/linden/linden-02.jpg";

const images = [linden01, linden02];

export function Linden() {
    ...
    <>
      ...
      <main>
        <div className="breadcrumb-boutique">
          ...
          <span className="breadcrumb-current">LINDEN</span>
        </div>

        <h1 className="titulo-coleccion boutique-title">LINDEN</h1>
        ...
        <ColeccionLayout infoUrl="/pdf/LINDEN.pdf" />
