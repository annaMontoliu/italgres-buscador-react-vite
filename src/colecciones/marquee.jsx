...
import marquee1 from "../assets/imagenes/marquee/marquee-01.jpg";
    ...
    <>
      ...
      <main>
        <div className="breadcrumb-boutique">
          ...
          <span className="breadcrumb-current">MARQUEE</span>
        </div>

        <h1 className="titulo-coleccion boutique-title">MARQUEE</h1>
        ...
        <ColeccionLayout infoUrl="/pdf/MARQUEE.pdf" />
