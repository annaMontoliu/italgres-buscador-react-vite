    ...
    <>
      ...
      <main>
        <div className="breadcrumb-boutique">
          ...
          <span className="breadcrumb-current">LIA</span>
        </div>

        <h1 className="titulo-coleccion boutique-title">LIA</h1>
        ...
        <ColeccionLayout infoUrl="/pdf/LIA.pdf" />
