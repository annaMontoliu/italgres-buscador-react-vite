...
import bonnie1 from "../assets/imagenes/bonnie/bonnie-01.jpg";
import bonnie2 from "../assets/imagenes/bonnie/bonnie-02.jpg";
    ...
    <>
      ...
      <main>
        <div className="breadcrumb-boutique">
          ...
          <span className="breadcrumb-current">BONNIE</span>
        </div>

        <h1 className="titulo-coleccion boutique-title">BONNIE</h1>
        ...
        <ColeccionLayout infoUrl="/pdf/BONNIE.pdf" />
