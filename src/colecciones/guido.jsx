...
const images = [guido01];

export function Guido() {
    ...
    <>
      ...
      <main>
        <div className="breadcrumb-boutique">
          ...
          <span className="breadcrumb-current">GUIDO</span>
        </div>

        <h1 className="titulo-coleccion boutique-title">GUIDO</h1>
        ...
        <ColeccionLayout infoUrl="/pdf/GUIDO.pdf" />
