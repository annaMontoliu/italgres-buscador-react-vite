...
const images = [cestio01];

export function Cestio() {
    ...
    <>
      ...
      <main>
        <div className="breadcrumb-boutique">
          ...
          <span className="breadcrumb-current">CESTIO</span>
        </div>

        <h1 className="titulo-coleccion boutique-title">CESTIO</h1>
        ...
        <ColeccionLayout infoUrl="/pdf/CESTIO.pdf" />
