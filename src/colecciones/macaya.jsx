...
import macaya02 from "../assets/imagenes/macaya/macaya-02.jpg";
import macaya03 from "../assets/imagenes/macaya/macaya-03.jpg";

const images = [macaya01, macaya02, macaya03];

export function Macaya() {
    ...
    <>
      ...
      <main>
        <div className="breadcrumb-boutique">
          ...
          <span className="breadcrumb-current">MACAYA</span>
        </div>

        <h1 className="titulo-coleccion boutique-title">MACAYA</h1>
        ...
        <ColeccionLayout infoUrl="/pdf/MACAYA.pdf" />
