...
const images = [alameda01];

export function Alameda() {
    ...
    <>
      ...
      <main>
        <div className="breadcrumb-boutique">
          ...
          <span className="breadcrumb-current">ALAMEDA</span>
        </div>

        <h1 className="titulo-coleccion boutique-title">ALAMEDA</h1>
        ...
        <ColeccionLayout infoUrl="/pdf/ALAMEDA.pdf" />
