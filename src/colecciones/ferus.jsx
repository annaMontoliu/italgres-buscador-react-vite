...
import ferus1 from "../assets/imagenes/ferus/ferus-01.jpg";
import ferus2 from "../assets/imagenes/ferus/ferus-02.jpg";
    ...
    <>
      ...
      <main>
        <div className="breadcrumb-boutique">
          ...
          <span className="breadcrumb-current">FERUS</span>
        </div>

        <h1 className="titulo-coleccion boutique-title">FERUS</h1>
        ...
        <ColeccionLayout infoUrl="/pdf/FERUS.pdf" />
