    ...
    <>
      ...
      <main>
        <div className="breadcrumb-boutique">
          ...
          <span className="breadcrumb-current">NUSA</span>
        </div>

        <h1 className="titulo-coleccion boutique-title">NUSA</h1>
        ...
        <ColeccionLayout infoUrl="/pdf/NUSA.pdf" />
